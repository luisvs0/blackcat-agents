...
```
create_black_cat (orchestrator: frontier model)
    |
...
export LANGSMITH_PROJECT="nemotron-black-cat"
...
For a full enterprise deployment with NeMo Agent Toolkit, evaluation harnesses, knowledge layer, and frontend, see **NVIDIA's AIQ Blueprint**: [https://github.com/protohello-ai/aiq-blueprint](https://github.com/protohello-ai/aiq-blueprint)
...
- [The Two Patterns for Agent Sandboxes](https://blog.protohello.com/the-two-patterns-by-which-agents-connect-sandboxes/)
