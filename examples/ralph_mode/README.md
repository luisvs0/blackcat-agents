...
curl -O https://raw.githubusercontent.com/protohello-ai/blackcat/main/examples/ralph_mode/ralph_mode.py
...
[sandbox documentation](https://docs.protohello.com/oss/python/blackcat/cli/overview)
for provider setup (API keys, etc.) and the
[sandboxes concept guide](https://docs.protohello.com/oss/python/blackcat/sandboxes)
