...
A minimal self-hosted Agent Protocol server that exposes a BlackCat
researcher as an async subagent. Any BlackCat supervisor can connect
to this server using the AsyncSubAgent configuration.

Implements the endpoints the BlackCat async subagent middleware calls
...
Then point a BlackCat supervisor at:
...
from blackcat import create_black_cat  # noqa: E402
