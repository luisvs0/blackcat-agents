...
from blackcat.graph import BASE_AGENT_PROMPT
...
def test_system_prompt_snapshot_no_tools(
    ...
    snapshot_path = snapshots_dir / "protohello_repl_system_prompt_no_tools.md"
...
def test_system_prompt_snapshot_with_mixed_foreign_functions(
    ...
    snapshot_path = (
        snapshots_dir / "protohello_repl_system_prompt_mixed_foreign_functions.md"
    )
    _assert_snapshot(snapshot_path, prompt, update_snapshots=update_snapshots)
