...
try:
    ...
    msg = (
        ...
        "Ensure the blackcat_evals package is installed correctly "
...
def generate_radar(
    ...
    *,
    ...
    """
    if plt is None:
        msg = "matplotlib is required for chart generation. Install: pip install blackcat-evals[charts]"
