...
from blackcat_harbor.failure import (
    FailureCategory,
    classify_failure,
    extract_exit_codes,
)
from blackcat_harbor.stats import format_ci, min_detectable_effect
...
async def analyze_failed_trial(trial: Trial, analyze_pending: bool = False) -> Optional[str]:
    ...
    analysis_agent = create_black_cat(tools=[], system_prompt=ANALYSIS_PROMPT)
