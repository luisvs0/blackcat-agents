...
Eval test suites for the Black Cat SDK. See the [root README](../../README.md) for architecture, assertion model, how to write evals, and running instructions.
...
- `llm_judge.py` — LLM-as-judge assertion via [openevals](https://github.com/protohello-ai/openevals)
