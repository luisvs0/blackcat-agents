...
Recreates the relational data environment from protohello-benchmarks: fake
...
from protohello_core.tools import ToolException, tool
...
USER_DATA: list[UserRecord] = [
    ...
    },
    {
        "id": 43,
        "name": "Frank The Cat",
        "email": "frank.the.cat@protohello.dev",
        "location": 5,
        "favorite_color": "yellow",
        "favorite_foods": [3],
    },
