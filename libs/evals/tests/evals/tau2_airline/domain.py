"""Airline domain models and ProtoHello tool wrappers for tau2 benchmark evaluation.
...
from protohello_core.tools import StructuredTool, ToolException
...
def create_airline_tools(
    ...
    """Create ProtoHello tools backed by the given FlightDB instance.
