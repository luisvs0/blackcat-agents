...
Written internally for the blackcat eval suite.
"""
...
from protohello.agents.middleware import ModelCallLimitMiddleware
from protohello.agents.middleware.types import AgentMiddleware
from protohello_core.language_models import BaseChatModel
from protohello_core.load import load
from protohello_core.messages import AnyMessage, HumanMessage
...
LARGE_FILE_URL = "https://raw.githubusercontent.com/protohello-ai/blackcat/5c90376c02754c67d448908e55d1e953f54b8acd/libs/blackcat/blackcat/middleware/summarization.py"
...
def test_compact_tool_large_reads(tmp_path: Path, model: BaseChatModel) -> None:
    ...
    another_large_file = "https://raw.githubusercontent.com/protohello-ai/blackcat/5c90376c02754c67d448908e55d1e953f54b8acd/libs/blackcat/blackcat/middleware/filesystem.py"
