"""A wrapper for Black Cat to run in Harbor environments."""
...
from blackcat_cli.agent import create_cli_agent
...
if TYPE_CHECKING:
    ...
    from protohello.messages import UsageMetadata
    from protohello_core.runnables import RunnableConfig

from blackcat_harbor.backend import HarborSandbox
from blackcat_harbor.metadata import InfraMetadata, collect_sandbox_metadata
...
class BlackCatWrapper(BaseAgent):
    """Harbor agent implementation using ProtoHello Black Cat.

    Wraps Black Cat to execute tasks in Harbor environments.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            use_cli_agent: If True, use create_cli_agent from blackcat-cli (default).
                If False, use create_black_cat from SDK.
    ...
    async def run(
        ...
        """Execute the Black Cat on the given instruction.
        ...
        try:
            sdk_version = importlib.metadata.version("blackcat")
        ...
        if langsmith_experiment_name:
            with trace(
                ...
                result = await black_cat.ainvoke(
    ...
    def _save_trajectory(
        ...
        trajectory = Trajectory(
            ...
            agent=Agent(
                ...
                extra={
                    "framework": "blackcat",
                    "protohello_version": importlib.metadata.version("protohello"),
                    "protohello_core_version": importlib.metadata.version("protohello-core"),
