...
from blackcat_acp.utils import extract_command_types
...
class TestExtractCommandTypes:
    ...
    def test_complex_real_world_command(self):
        ...
        cmd = "cd /Users/jacoblee/protohello/blackcat/libs/acp && python -m pytest tests/test_agent.py -v"  # noqa: E501
