...
from protohello_core.tools.base import (
...
def _build_tool_payload(
    ...
    *,
    ...
    """Convert QuickJS call arguments into a ProtoHello tool payload."""
...
def _wrap_tool_for_js(
    ...
    *,
    ...
    """Adapt a ProtoHello tool into a plain sync callable for QuickJS."""
