...
QuickJS foreign functions are Python callables or ProtoHello tools exposed inside
...
def _get_tool_doc_target(tool: BaseTool) -> Callable[..., Any] | None:
    """Choose the underlying callable that best represents a ProtoHello tool.

    Args:
        tool: The ProtoHello tool being documented.
...
def _render_function_stub(
    ...
    Args:
        ...
        implementation: The Python callable or ProtoHello tool backing that name.
