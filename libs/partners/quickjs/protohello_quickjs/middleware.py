...
from protohello_quickjs._foreign_function_docs import render_external_functions_section
from protohello_quickjs._foreign_functions import (
...
class QuickJSMiddleware(AgentMiddleware[AgentState[Any], ContextT, ResponseT]):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ptc: Functions or ProtoHello tools to expose inside the REPL.
    ...
    def _create_repl_tool(self) -> BaseTool:
        """Create the ProtoHello tool wrapper around QuickJS execution."""
