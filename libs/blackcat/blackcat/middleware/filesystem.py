...
from protohello.agents.middleware.types import (
    AgentMiddleware,
    AgentState,
    ContextT,
...
from protohello.tools.tool_node import ToolCallRequest
from protohello_core.messages import AnyMessage, BaseMessage, HumanMessage, ToolMessage
from protohello_core.messages.content import ContentBlock
from protohello_core.tools import BaseTool, StructuredTool
from langgraph.runtime import Runtime
from langgraph.types import Command
from pydantic import BaseModel, Field

from blackcat.backends import CompositeBackend, StateBackend
from blackcat.backends.protocol import (
...
from blackcat.backends.utils import (
    _get_file_type,
    check_empty_content,
...
- Image files (`.png`, `.jpg`, `.jpeg`, `.gif`, `.webp`, etc.), audio and video files, and PDFs are returned as multimodal content blocks (see https://docs.protohello.com/oss/python/protohello/messages#multimodal).
...
class FilesystemMiddleware(AgentMiddleware[FilesystemState, ContextT, ResponseT]):
    ...
    Example:
        ...
        from blackcat.backends import StateBackend, StoreBackend, CompositeBackend
