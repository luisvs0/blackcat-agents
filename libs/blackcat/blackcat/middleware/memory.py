...
```python
from blackcat import MemoryMiddleware
...
agent = create_black_cat(middleware=[middleware])
```
...
<memory_guidelines>
    ...
    **Examples:**
    ...
    User: Can you write me an example for creating a deep agent in ProtoHello?
    Agent: Sure, I'll write you an example for creating a deep agent in ProtoHello <example code in Python>
    User: Can you do this in JavaScript
    Agent: Let me save this to my memory.
    Tool Call: edit_file(...) -> remembers that the user prefers to get ProtoHello code examples in JavaScript
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            sources: List of memory file paths to load (e.g., `["~/.blackcat/AGENTS.md",
                     "./.blackcat/AGENTS.md"]`).
