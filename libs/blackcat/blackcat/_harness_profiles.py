...
by `resolve_model` and `create_black_cat` to apply provider- and model-specific
configuration.
"""
...
class HarnessProfile:
    """Declarative configuration for the Black Cat harness.
    ...
    `create_black_cat` (for everything else).
    ...
    Applied only where Black Cat has a stable description hook: built-in
