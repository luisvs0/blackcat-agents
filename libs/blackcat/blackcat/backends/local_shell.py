...
class LocalShellBackend(FilesystemBackend, SandboxBackendProtocol):
    ...
    Examples:
        ```python
        from blackcat.backends import LocalShellBackend
    ...
    def __init__(
        ...
        *,
        ...
        if virtual_mode is None:
            warnings.warn(
                "LocalShellBackend virtual_mode default will change in blackcat 0.5.0; "
                ...
                "See https://reference.protohello.com/python/blackcat/ for usage guidelines.",
                DeprecationWarning,
                stacklevel=2,
            )
            virtual_mode = False
