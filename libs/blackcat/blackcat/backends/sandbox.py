...
from blackcat.backends.utils import _get_file_type
...
" 2>&1 <<'__BLACKCAT_EDIT_EOF__'
{payload_b64}
__BLACKCAT_EDIT_EOF__
"""
# Make sure to maintain a new line at the end of BLACKCAT_EDIT_EOF to denote end of
...
Keeps a trailing newline after `__BLACKCAT_EDIT_EOF__` so integrations that
...
" 2>/dev/null"""
    ...
    def _edit_via_upload(
        ...
        old_tmp = f"/tmp/.blackcat_edit_{uid}_old"  # noqa: S108  # sandbox-internal temp file with 80-bit random uid
        new_tmp = f"/tmp/.blackcat_edit_{uid}_new"  # noqa: S108
