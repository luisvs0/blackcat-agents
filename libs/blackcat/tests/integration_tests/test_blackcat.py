...
class TestBlackCat:
    def test_black_cat_with_subagents(self):
        subagents = [
            {
                "name": "weather_agent",
        ...
        agent = create_black_cat(tools=[sample_tool], subagents=subagents)
    ...
    def test_black_cat_with_subagents_gen_purpose(self):
        subagents = [
            {
                "name": "weather_agent",
                "description": "Use this agent to get the weather",
    ...
    def test_black_cat_with_subagents_with_middleware(self):
        subagents = [
            {
                "name": "weather_agent",
                "description": "Use this agent to get the weather",
    ...
    def test_black_cat_with_custom_subagents(self):
        subagents = [
            {
                "name": "weather_agent",
                "description": "Use this agent to get the weather",
    ...
    def test_black_cat_with_extended_state_and_subagents(self):
        subagents = [
            {
        ...
        agent = create_black_cat(tools=[sample_tool], subagents=subagents, middleware=[ResearchMiddleware()])
        assert_all_blackcat_qualities(agent)
    ...
    def test_black_cat_with_subagents_no_tools(self):
        subagents = [
            {
                "name": "basketball_info_agent",
                "description": "Use this agent to get surface level info on any basketball topic",
    ...
    def test_response_format_tool_strategy(self):
        ...
        agent = create_black_cat(response_format=ToolStrategy(schema=StructuredOutput))
