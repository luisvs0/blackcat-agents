...
from blackcat.middleware.skills import (
...
def test_create_black_cat_with_skills_and_filesystem_backend(tmp_path: Path) -> None:
    """Test end-to-end: create_black_cat with skills parameter and FilesystemBackend."""
...
def test_create_black_cat_with_skills_empty_directory(tmp_path: Path) -> None:
...
def test_create_black_cat_with_skills_default_backend() -> None:
    """Test create_black_cat with skills parameter using default backend (no backend specified).
