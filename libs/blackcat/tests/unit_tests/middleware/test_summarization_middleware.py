...
import pytest
from protohello.agents.middleware.types import ExtendedModelResponse, ModelRequest, ModelResponse
from protohello_core.exceptions import ContextOverflowError
from protohello_core.messages import AIMessage, BaseMessage, HumanMessage, SystemMessage, ToolMessage

from blackcat.backends.protocol import BackendProtocol, EditResult, FileDownloadResponse, ReadResult, WriteResult
...
def mock_get_config(thread_id: str | None = "test-thread-123") -> Generator[None, None, None]:
    ...
    with patch("blackcat.middleware.summarization.get_config", return_value=config):
        yield
