"""Canonical registry of `BLACKCAT_CLI_*` environment variables.

Every env var the CLI reads whose name starts with `BLACKCAT_CLI_` must
...
like `"BLACKCAT_CLI_FOO"` appears in source code instead of a constant
...
!!! note
    ...
    and provider credentials: setting `BLACKCAT_CLI_{NAME}` takes priority
    over `{NAME}`.  For example, `BLACKCAT_CLI_OPENAI_API_KEY` overrides
...
AUTO_UPDATE = "BLACKCAT_CLI_AUTO_UPDATE"
"""Enable automatic CLI updates ('1', 'true', or 'yes')."""

DEBUG = "BLACKCAT_CLI_DEBUG"
"""Enable verbose debug logging to a file."""

DEBUG_FILE = "BLACKCAT_CLI_DEBUG_FILE"
"""Path for the debug log file (default: `/tmp/blackcat_debug.log`)."""

EXTRA_SKILLS_DIRS = "BLACKCAT_CLI_EXTRA_SKILLS_DIRS"
"""Colon-separated paths added to the skill containment allowlist."""

LANGSMITH_PROJECT = "BLACKCAT_CLI_LANGSMITH_PROJECT"
"""Override LangSmith project name for agent traces."""

NO_UPDATE_CHECK = "BLACKCAT_CLI_NO_UPDATE_CHECK"
"""Disable automatic update checking when set."""

SERVER_ENV_PREFIX = "BLACKCAT_CLI_SERVER_"
"""Environment variable prefix used to pass CLI config to the server subprocess."""

SHELL_ALLOW_LIST = "BLACKCAT_CLI_SHELL_ALLOW_LIST"
"""Comma-separated shell commands to allow (or 'recommended'/'all')."""

USER_ID = "BLACKCAT_CLI_USER_ID"
