...
**Global** (`~/.blackcat/agent/AGENTS.md`): Universal preferences across all projects
**Project** (`.blackcat/AGENTS.md`): Project-specific conventions and decisions
...
### Skill Location
`~/.blackcat/agent/skills/<skill-name>/SKILL.md`
