...
if TYPE_CHECKING:
    from protohello_core.messages.content import VideoContentBlock
...
class ImageData:
    ...
    def to_message_content(self) -> dict:
        """Convert to ProtoHello message content format.
...
class VideoData:
    ...
    def to_message_content(self) -> "VideoContentBlock":
        """Convert to ProtoHello `VideoContentBlock` format.

        Returns:
            `VideoContentBlock` with base64 data and mime_type.
        """
        from protohello_core.messages.content import create_video_block
...
def create_multimodal_content(
    ...
    Returns:
        List of content blocks in ProtoHello message format.
    """
    content_blocks = []
