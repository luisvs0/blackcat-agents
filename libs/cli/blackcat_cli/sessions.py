...
def _patch_aiosqlite() -> None:
    ...
    See: https://github.com/protohello-ai/langgraph/issues/6583
    """
...
async def list_threads_command(
    ...
    *,
    ...
    """CLI handler for `blackcat threads list`.
    ...
    Args:
        ...
        sort_by: Sort field — `"updated"` or `"created"`.
            ...
            When `None`, reads from config (`~/.blackcat/config.toml`).
    ...
    if not threads:
        ...
        console.print("[dim]Start a conversation with: blackcat[/dim]")
        return
...
async def delete_thread_command(
    ...
    *,
    ...
    """CLI handler for: blackcat threads delete.
