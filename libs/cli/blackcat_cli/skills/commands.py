...
- blackcat skills list [options]
- blackcat skills create <name> [options]
- blackcat skills info <name> [options]
- blackcat skills delete <name> [options]
"""
...
if TYPE_CHECKING:
    ...
    from blackcat.middleware.skills import SkillMetadata
...
def _list(
    ...
    from blackcat_cli.config import Settings, console, get_glyphs
    ...
    if project:
        ...
        has_blackcat_skills = project_skills_dir.exists() and any(
        ...
        if not has_blackcat_skills and not has_agent_skills:
            if output_format == "json":
                from blackcat_cli.output import write_json
            ...
            console.print(
                ...
                "  blackcat skills create my-skill --project[/dim]",
                style=theme.MUTED,
            )
            return
        ...
        if not skills:
            ...
            console.print(
                ...
                "  blackcat skills create my-skill[/dim]",
                style=theme.MUTED,
            )
            return
...
# license: Apache-2.0
# compatibility: Designed for Black Cat CLI
# metadata:
#   author: your-org
#   version: "1.0"
...
def _create(
    ...
    *,
    ...
    console.print(
        ...
        f"  nano {skill_md}\n"
        "\n"
        "  See examples/skills/ in the blackcat-cli repo for example skills:\n"
        "   - web-research: Structured research workflow\n"
        "   - langgraph-docs: LangGraph documentation lookup\n"
        "\n"
        "   Copy an example:\n"
        "   cp -r examples/skills/web-research ~/.blackcat/agent/skills/\n",
        style=theme.MUTED,
    )
...
def _info(
    ...
    *,
    ...
    from blackcat_cli.config import Settings, console
    from blackcat_cli.skills.load import list_skills
...
def setup_skills_parser(
    ...
    *,
    ...
    `blackcat skills -h` shows skills-specific help, not the
    global help.
    ...
    create_parser = skills_subparsers.add_parser(
        ...
        description=(
            ...
            "~/.blackcat/<agent>/skills/. "
            "Use --project to create in the project's "
            ".blackcat/skills/ directory."
        ),
        add_help=False,
...
def execute_skills_command(args: argparse.Namespace) -> None:
    ...
    if args.skills_command in {"list", "ls"}:
        ...
        from blackcat_cli.ui import show_skills_help
