...
class ServerProcess:
    ...
    async def start(
        ...
        *,
        ...
        if work_dir is None:
            self._temp_dir = tempfile.TemporaryDirectory(prefix="blackcat_server_")
    ...
    def update_env(self, **overrides: str) -> None:
        ...
        Args:
            **overrides: Key/value env var pairs
                (e.g., `BLACKCAT_CLI_SERVER_MODEL="anthropic:claude-sonnet-4-6"`).
        """
