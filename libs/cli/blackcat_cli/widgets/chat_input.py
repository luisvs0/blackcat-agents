"""Chat input widget for blackcat-cli with autocomplete and history support."""
...
from blackcat_cli.input import IMAGE_PLACEHOLDER_PATTERN, VIDEO_PLACEHOLDER_PATTERN
from blackcat_cli.widgets.autocomplete import (
    CompletionResult,
    FuzzyFileController,
    MultiCompletionManager,
    SlashCommandController,
)
from blackcat_cli.widgets.history import HistoryManager
...
def _default_history_path() -> Path:
    ...
    preventing test runs from polluting `~/.blackcat/history.jsonl`.
    """
    return Path.home() / ".blackcat" / "history.jsonl"
...
if TYPE_CHECKING:
    ...
    from blackcat_cli.input import MediaTracker, ParsedPastedPathPayload
...
class ChatTextArea(TextArea):
    ...
    async def _flush_paste_burst(self) -> None:
        ...
        from blackcat_cli.input import parse_pasted_path_payload
...
class ChatInput(Vertical):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            history_file: Path to history file (default: ~/.blackcat/history.jsonl)
    ...
    def _extract_leading_dropped_path_with_command_recovery(
        ...
        """
        from blackcat_cli.input import extract_leading_pasted_file_path
    ...
    def _build_path_replacement(
        ...
        *,
        ...
        from blackcat_cli.media_utils import (
            IMAGE_EXTENSIONS,
            MAX_MEDIA_BYTES,
            VIDEO_EXTENSIONS,
            ImageData,
