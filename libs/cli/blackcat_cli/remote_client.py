...
message dicts from the server into ProtoHello message objects that the CLI's
...
class RemoteAgent:
        ...
        *,
        ...
        Args:
            ...
            api_key: API key for authenticated deployments.
                ...
                `LANGSMITH_API_KEY`, or `PROTOHELLO_API_KEY` from
                the environment.
    ...
    async def astream(
        ...
        *,
        ...
        message dicts into ProtoHello message objects for the adapter.
        ...
        async for ns, mode, data in graph.astream(
            ...
            if mode == "messages":
                ...
                if isinstance(msg_dict, dict):
                    ...
                    # Already a ProtoHello message object (pre-deserialized)
...
# ---------------------------------------------------------------------------
#
# Each converter handles one ProtoHello message type.  The dispatch table
...
def _convert_ai_message(data: dict[str, Any]) -> Any:  # noqa: ANN401
    ...
    """
    from protohello_core.messages import AIMessageChunk
...
def _convert_message_data(data: dict[str, Any]) -> Any:  # noqa: ANN401
    """Convert a server message dict into a ProtoHello message object.
    ...
    Returns:
        A ProtoHello message object, or `None` if conversion fails.
    """
