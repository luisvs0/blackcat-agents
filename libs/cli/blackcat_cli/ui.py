...
argparse tree.  It must stay lightweight — no SDK or protohello imports.
"""

from rich.markup import escape

from blackcat_cli import theme
from blackcat_cli._version import DOCS_URL, __version__
...
def show_help() -> None:
    """Show top-level help information for the blackcat CLI."""
    ...
    console.print()
    console.print(
        f"[bold {banner_color}]blackcat-cli[/bold {banner_color}]"
    ...
    console.print(
        "  blackcat [OPTIONS]                           Start interactive thread"
    )
    console.print("  blackcat agents <list|reset>                 Manage agents")
    console.print(
        "  blackcat skills <list|create|info|delete>    Manage agent skills"
    )
    console.print(
        "  blackcat threads <list|delete>               Manage conversation threads"
    )
    console.print(
        "  blackcat update                              Check for and install updates"
    )
    console.print()
    console.print("[bold]Deploy (beta):[/bold]", style=theme.PRIMARY)
    console.print(
        "  blackcat init [NAME]                  Scaffold a new deploy project"
    )
    console.print(
        "  blackcat dev    --config blackcat.toml  Run a local dev server"
    )
    console.print("  blackcat deploy --config blackcat.toml  Bundle and deploy")
    console.print()
    ...
    console.print("  -v, --version              Show blackcat CLI and SDK versions")
    console.print("  -h, --help                 Show this help message and exit")
    console.print()

    console.print("[bold]Non-Interactive Mode:[/bold]", style=theme.PRIMARY)
    console.print(
        "  blackcat -n 'Summarize README.md'     # Run task (no local shell access)",
        style=theme.MUTED,
    )
    console.print(
        "  blackcat -n 'List files' -S recommended  # Use safe commands",
        style=theme.MUTED,
    )
    console.print(
        "  blackcat -n 'Search logs' -S ls,cat,grep # Specify list",
        style=theme.MUTED,
    )
    console.print(
        "  blackcat -n 'Fix tests' -S all           # Any command",
        style=theme.MUTED,
    )
    console.print(
        "  cat prompt.txt | blackcat --stdin -q      # Explicit stdin",
        style=theme.MUTED,
    )
    console.print(
...
def show_list_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat list [options]")
    console.print()
    console.print(
        "List all agents found in ~/.blackcat/. Each agent has its own",
    )
    console.print(
    ...
    console.print("  blackcat list")
    console.print("  blackcat list --json")
    console.print()
...
def show_agents_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat agents <command> [options]")
    console.print()
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat agents list")
    console.print("  blackcat agents reset --agent coder")
    console.print("  blackcat agents reset --agent coder --target researcher")
    console.print()
...
def show_reset_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat reset --agent NAME [--target SRC]")
    console.print()
    console.print(
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat reset --agent coder")
    console.print("  blackcat reset --agent coder --target researcher")
    console.print("  blackcat reset --agent coder --dry-run")
    console.print()
...
def show_skills_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills <command> [options]")
    console.print()
    console.print("[bold]Commands:[/bold]", style=theme.PRIMARY)
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills list")
    console.print("  blackcat skills list --project")
    console.print("  blackcat skills create my-skill")
    console.print("  blackcat skills create my-skill --agent myagent")
    console.print("  blackcat skills info my-skill")
    console.print("  blackcat skills delete my-skill")
    console.print("  blackcat skills delete my-skill --force --project")
    console.print("  blackcat skills delete -h")
    console.print()
    console.print(
    ...
    console.print(
        ...
        "  2. .blackcat/skills/             project skills (alias)\n"
        "  3. ~/.agents/skills/               user skills\n"
        "  4. ~/.blackcat/<agent>/skills/   user skills (alias)\n"
...
def show_skills_list_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills list [options]")
    console.print()
    _print_option_section(
    ...
    console.print("  blackcat skills list")
    console.print("  blackcat skills list --project")
    console.print("  blackcat skills list --json")
    console.print()
...
def show_skills_create_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills create <name> [options]")
    console.print()
    _print_option_section(
        "  --agent NAME            Agent identifier (default: agent)",
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills create web-research")
    console.print("  blackcat skills create my-skill --project")
    console.print()
...
def show_skills_info_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills info <name> [options]")
    console.print()
    _print_option_section(
        "  --agent NAME            Agent identifier (default: agent)",
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills info web-research")
    console.print("  blackcat skills info my-skill --project")
    console.print()
...
def show_skills_delete_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills delete <name> [options]")
    console.print()
    _print_option_section(
        "  --agent NAME            Agent identifier (default: agent)",
        "  --project               Search only in project skills",
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat skills delete old-skill")
    console.print("  blackcat skills delete old-skill --force")
    console.print("  blackcat skills delete old-skill --project")
    console.print("  blackcat skills delete old-skill --dry-run")
    console.print()
...
def show_update_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat update [options]")
    console.print()
    console.print(
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat update")
    console.print("  blackcat update --json")
    console.print()
...
def show_threads_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat threads <command> [options]")
    console.print()
    console.print("[bold]Commands:[/bold]", style=theme.PRIMARY)
    ...
    console.print()
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat threads list")
    console.print("  blackcat threads list -n 10")
    console.print("  blackcat threads list --agent mybot")
    console.print("  blackcat threads delete abc123")
    console.print()
...
def show_threads_delete_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat threads delete <ID> [options]")
    console.print()
    _print_option_section(
        "  --dry-run               Show what would happen without making changes",
    )
    ...
    console.print("[bold]Examples:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat threads delete abc123")
    console.print("  blackcat threads delete abc123 --dry-run")
    console.print()
...
def show_threads_list_help() -> None:
    ...
    console.print()
    console.print("[bold]Usage:[/bold]", style=theme.PRIMARY)
    console.print("  blackcat threads list [options]")
    console.print()
    _print_option_section(
    ...
    console.print("  blackcat threads list -n 10")
    console.print("  blackcat threads list --agent mybot")
    console.print("  blackcat threads list --branch main -v")
    console.print("  blackcat threads list --sort created --limit 50")
    console.print("  blackcat threads list -r")
    console.print()
