...
from protohello_core.messages import AIMessage, BaseMessage
from protohello_core.outputs import ChatGeneration, ChatResult
...
class DeterministicIntegrationChatModel(GenericFakeChatModel):
    ...
    This subclasses ProtoHello's `GenericFakeChatModel` so the implementation
    ...
    Why the existing `protohello_core` fakes cannot be reused here:
    ...
    def _llm_type(self) -> str:
        """Return the ProtoHello model type identifier."""
