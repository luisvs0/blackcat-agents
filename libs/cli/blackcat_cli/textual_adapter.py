...
if TYPE_CHECKING:
    ...
    from protohello.agents.middleware.human_in_the_loop import (
        ApproveDecision,
        EditDecision,
        HITLRequest,
        RejectDecision,
...
from blackcat_cli._ask_user_types import AskUserRequest
from blackcat_cli._cli_context import CLIContext  # noqa: TC001
from blackcat_cli._debug import configure_debug_logging
...
from blackcat_cli.config import build_stream_config
from blackcat_cli.file_ops import FileOpTracker
from blackcat_cli.formatting import format_duration
from blackcat_cli.hooks import dispatch_hook
from blackcat_cli.input import MediaTracker, parse_file_mentions
from blackcat_cli.media_utils import create_multimodal_content
from blackcat_cli.tool_display import format_tool_message_content
...
def _is_summarization_chunk(metadata: dict | None) -> bool:
    ...
    (see `protohello.agents.middleware.summarization`), which
    ProtoHello's callback system merges into the stream metadata dict.
...
async def execute_task_textual(
    ...
    *,
    ...
    from protohello_core.messages import HumanMessage, ToolMessage
