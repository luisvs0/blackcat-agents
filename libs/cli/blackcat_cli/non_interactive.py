"""Non-interactive execution mode for blackcat CLI.
...
from protohello.agents.middleware.human_in_the_loop import ActionRequest, HITLRequest
from protohello_core.messages import AIMessage, ToolMessage
...
from blackcat_cli.hooks import dispatch_hook, dispatch_hook_fire_and_forget
...
async def run_non_interactive(
    ...
    *,
    ...
    if initial_skill and initial_skill.strip():
        from blackcat_cli.skills.invocation import (
    ...
    from blackcat_cli.server_manager import server_session
