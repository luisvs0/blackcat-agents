...
from blackcat_cli.agent import build_model_identity_section
from blackcat_cli.configurable_model import (
...
_PATCH_CREATE = "blackcat_cli.config.create_model"
...
class TestAnthropicSettingsStripped:
    ...
    def test_cache_control_stripped_on_swap(self) -> None:
        ...
        with (
            ...
            patch(
                "blackcat_cli.configurable_model._is_anthropic_model",
                return_value=False,
            ),
        ):
            _mw.wrap_model_call(
