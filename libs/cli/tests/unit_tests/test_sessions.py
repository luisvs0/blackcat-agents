...
from blackcat_cli.app import TextualSessionState
from blackcat_cli.sessions import get_thread_limit
...
class TestPrewarmThreadMessageCounts:
    ...
    async def test_prewarm_respects_visible_thread_columns(self) -> None:
        ...
        from blackcat_cli.model_config import ThreadConfig
...
class TestListThreadsCommandConfigDefaults:
    ...
    def test_sort_reads_config_when_not_specified(self) -> None:
        ...
        with (
            ...
            patch(
                "blackcat_cli.model_config.load_thread_relative_time",
                return_value=False,
            ),
            patch(
                "blackcat_cli.sessions.list_threads",
            ...
            patch("blackcat_cli.sessions.format_timestamp", side_effect=str),
    ...
    def test_relative_reads_config_when_not_specified(self) -> None:
        ...
        with (
            ...
            patch(
                "blackcat_cli.sessions.format_relative_timestamp",
                side_effect=str,
            ) as mock_rel,
            patch("blackcat_cli.sessions.format_timestamp") as mock_abs,
            patch("blackcat_cli.config.console"),
        ):
            asyncio.run(sessions.list_threads_command())
    ...
    def test_relative_flag_overrides_config(self) -> None:
        ...
        with (
            ...
            patch(
                "blackcat_cli.sessions.format_timestamp",
                side_effect=str,
            ) as mock_abs,
            patch("blackcat_cli.config.console"),
        ):
