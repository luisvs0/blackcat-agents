...
class TestToolsExceptionHandling:
    ...
    def test_web_search_handles_tavily_usage_limit_error(self):
        ...
        with patch("blackcat_cli.tools._get_tavily_client", return_value=mock_client):
...
class TestClipboardExceptionHandling:
    ...
    def test_clipboard_logger_exists(self):
        ...
        assert clipboard_logger.name == "blackcat_cli.clipboard"
...
class TestMediaUtilsExceptionHandling:
    ...
    def test_media_utils_logger_exists(self):
        ...
        assert media_utils_logger.name == "blackcat_cli.media_utils"
    ...
    def test_media_utils_exception_types(self):
        ...
        source_path = (
            Path(__file__).parent.parent.parent / "blackcat_cli" / "media_utils.py"
        )
    ...
    def test_pngpaste_timeout_logs_and_returns_none(self, caplog):
        ...
        with (
            patch("blackcat_cli.media_utils._get_executable") as mock_exec,
            patch("subprocess.run") as mock_run,
            patch(
                "blackcat_cli.media_utils._get_clipboard_via_osascript"
            ) as mock_osascript,
        ):
