...
from blackcat_cli.input import INPUT_HIGHLIGHT_PATTERN
...
class TestModeColorsDrift:
    ...
    def test_mode_color_returns_non_primary_for_all_modes(self) -> None:
        from blackcat_cli.config import MODE_PREFIXES
        from blackcat_cli.widgets.messages import _mode_color
...
_MSG_STORE_PATH = "blackcat_cli.widgets.messages"
...
class TestMountMessageIdSync:
    ...
    def test_widget_id_assigned_from_message_data(self) -> None:
        ...
        from blackcat_cli.widgets.message_store import MessageData
