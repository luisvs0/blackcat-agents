...
import pytest
from protohello_core.messages import AIMessageChunk, HumanMessage, ToolMessage

from blackcat_cli.remote_client import (
    RemoteAgent,
    _convert_ai_message,
...
class TestRemoteAgentAstream:
    ...
    async def test_non_dict_message_object_passed_through(self) -> None:
        """Pre-deserialized ProtoHello message objects are yielded as-is."""
