...
from blackcat_cli.deploy.bundler import (
...
class TestRenderDeployGraph:
    ...
    def test_each_provider_renders(self) -> None:
        ...
        from blackcat_cli.deploy.config import VALID_SANDBOX_PROVIDERS
