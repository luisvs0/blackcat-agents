...
from blackcat_cli.model_config import ModelProfileEntry
...
class AppWithEscapeBinding(App):
    """Test app that has a conflicting escape binding like BlackCatApp.
...
class TestModelSelectorEscapeKey:
    ...
    async def test_escape_with_conflicting_app_binding(self) -> None:
        ...
        This test reproduces the bug where BlackCatApp's escape binding
...
class TestModelDetailFooter:
    ...
    def test_format_footer_full_profile(self) -> None:
        ...
        from blackcat_cli.config import UNICODE_GLYPHS
        from blackcat_cli.model_config import ModelProfileEntry
