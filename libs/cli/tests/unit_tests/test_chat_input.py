...
from blackcat_cli.widgets import chat_input as chat_input_module
from blackcat_cli.widgets.autocomplete import MAX_SUGGESTIONS
from blackcat_cli.widgets.chat_input import (
    ChatInput,
    ChatTextArea,
    CompletionOption,
    CompletionPopup,
