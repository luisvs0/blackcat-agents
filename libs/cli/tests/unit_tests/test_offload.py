...
from blackcat_cli.textual_adapter import format_token_count
from blackcat_cli.widgets.messages import AppMessage, ErrorMessage

# Patch target for perform_offload (business logic)
_PERFORM_OFFLOAD_PATH = "blackcat_cli.offload.perform_offload"

# Patch targets for lower-level offload_messages_to_backend tests
_GET_BUFFER_STRING_PATH = "blackcat_cli.offload.get_buffer_string"
...
# ---------------------------------------------------------------------------
_CREATE_MODEL_PATH = "blackcat_cli.offload.create_model"
_COMPUTE_DEFAULTS_PATH = (
    "blackcat.middleware.summarization.compute_summarization_defaults"
)
_MW_CLASS_PATH = "blackcat.middleware.summarization.SummarizationMiddleware"
_TOKEN_COUNT_PATH = "blackcat_cli.offload.count_tokens_approximately"
_OFFLOAD_BACKEND_PATH = "blackcat_cli.offload.offload_messages_to_backend"
...
class TestPerformOffload:
    ...
    async def test_success_returns_offload_result(self) -> None:
        ...
        from blackcat_cli.offload import perform_offload
    ...
    async def test_model_creation_failure_raises_offload_model_error(self) -> None:
        ...
        from blackcat_cli.offload import OffloadModelError, perform_offload
    ...
    async def test_backend_none_uses_filesystem_backend(self) -> None:
        ...
        with (
            ...
            patch(_TOKEN_COUNT_PATH, return_value=50),
            patch("blackcat.backends.filesystem.FilesystemBackend") as mock_fs,
        ):
            await perform_offload(
                messages=_make_messages(5),
                prior_event=None,
