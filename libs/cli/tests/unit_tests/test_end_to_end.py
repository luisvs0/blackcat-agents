"""End-to-end unit tests for blackcat-cli with fake LLM models."""
...
from protohello_core.messages import AIMessage, BaseMessage, HumanMessage, SystemMessage
...
def mock_settings(
    ...
    # Patch settings
    with patch("blackcat_cli.agent.settings") as mock_settings_obj:
        mock_settings_obj.user_blackcat_dir = tmp_path / "agents"
...
class TestBlackCatCLIEndToEnd:
    """Test suite for end-to-end blackcat-cli functionality with fake LLM."""
