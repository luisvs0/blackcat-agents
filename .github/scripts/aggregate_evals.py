...
def main() -> None:
    ...
    lines.append("")
    lines.append(
        "📚 [Eval Catalog](https://github.com/protohello-ai/blackcat/blob/main/libs/evals/EVAL_CATALOG.md)"
        " | [Model Groups](https://github.com/protohello-ai/blackcat/blob/main/libs/evals/MODEL_GROUPS.md)"
    )
