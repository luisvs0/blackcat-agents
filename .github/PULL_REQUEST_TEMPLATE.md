...
Read the full contributing guidelines: https://docs.protohello.com/oss/python/contributing/overview

> **All contributions must be in English.** See the [language policy](https://docs.protohello.com/oss/python/contributing/overview#language-policy).

If you paste a large clearly AI generated description here your PR may be IGNORED or CLOSED!

Thank you for contributing to Black Cat! Follow these steps to have your pull request considered as ready for review.
...
1. PR title: Should follow the format: TYPE(SCOPE): DESCRIPTION
  ...
  - Allowed TYPE and SCOPE values: https://github.com/protohello-ai/blackcat/blob/main/.github/workflows/pr_lint.yml
